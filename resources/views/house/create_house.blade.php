...
{{--{{!!  Form::open()!!}--}}
{{--{{!! Form::close() !!}}--}}
<form action="{{action(\App\Http\Controllers\HousesController::class, 'store')}}" enctype="multipart/form-data" >
...
<br>
Этаж: <input type="text" name = "floors"> <br>
Кол-во комнат: <input type="text" name = "rooms"><br>
Площадь:   <input type="text" name = "space"><br>
